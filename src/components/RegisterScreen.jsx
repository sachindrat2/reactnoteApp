...
const RegisterScreen = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col bg-gray-950">
      ...
      {/* Main Content */}
      <div className="relative z-10 flex-1 flex flex-col justify-center p-4 sm:p-6 lg:p-8 overflow-y-auto">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className="appearance-none rounded-xl block w-full px-4 py-3 border border-gray-600 placeholder-gray-500 text-white bg-gray-800/50 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
